...
import { ADDEMAILTES, AddPatientapi } from '@components/Api/AllApi';
...
const schema = yup.object().shape({
    ...
    Subject: yup.string().required('Prefer Name is required field'),
...
const AddEmailTempalets = ({ type }) => {
    ...
    return (
        <>
            <Sidebar />
            <Panel />
            <Page title="Create Email Templates">
                <div key="balance">
                    <Box mt={2}>
                        <Widget >
                            <Container>
                                            ...
                                            <form onSubmit={handleSubmit}>
                                                <Grid container spacing={2}>
                                                    ...
                                                    <Grid item xs={12} md={6}>
                                                        ...
                                                        <TextField id={`${type}ProfileLastName`} title="Last Name" size="small" name="Subject" placeholder="Preferred Name" value={values.Subject} onChange={handleChange} onBlur={handleBlur} fullWidth />
                                                        {
                                                    ...
                                                    <Grid item xs={12} md={6}>
                                                        ...
                                                        <TextField id={`${type}ProfileAddress1`} title="EmailContent" name="EmailContent" size="small" onChange={handleChange} onBlur={handleBlur} placeholder="EmailContent" fullWidth value={values.EmailContent} />
                                                        {
                                                    ...
                                                    <Grid item xs={12} md={6} mt={2}>
                                                        <button style={{ width: '250px', backgroundColor: '#2BAA27', height: '40px', borderRadius: 4, color: 'white', fontWeight: 600 }} handler={notify} type="submit" bgcolor="success" variant="contained">Create Email Template</button>
                                                    </Grid>
                                                </Grid>
                                            </form>
                                        </Container>
...
AddEmailTempalets.propTypes = {
    type: PropTypes.oneOf(['patient']).isRequired
}

export default AddEmailTempalets;