...
import { AllAppointmentDetails, GetSingleAppp, GetTypeAppointment } from '@components/Api/AllApi';
import './style.css'
...
export default function MYCalendar() {
    ...
    const { type_id, note, status, start_date, end_date, id, appointment_color } = hh;
